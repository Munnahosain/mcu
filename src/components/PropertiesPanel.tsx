...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
  ...
  return (
    <aside className="w-80 bg-[#101114] border-l border-[#252a31] flex flex-col h-full overflow-y-auto select-none text-[#f5f7f8] text-xs">
      {/* Panel Header */}
      <div className="p-3.5 border-b border-[#252a31] flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm text-[#f5f7f8]">
            {selectedElement ? 'Element Inspector' : 'Fabric & Artboard Settings'}
          </span>
        </div>
        {selectedElement && (
          ...
          <>
            <div className="bg-[#17191e] p-3 rounded-lg border border-[#252a31] space-y-3">
              <div className="flex items-center gap-2 text-[#18c98a] font-semibold text-xs">
                ...
                <span>1:1 Master Artboard Dimensions</span>
              </div>
              <p className="text-[11px] text-[#aeb5bf] leading-relaxed">
                The master repeat artboard maintains a strict 1:1 square ratio for seamless fabric tiling.
              </p>

              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-[10px] text-[#77808c]">Repeat Physical Size</label>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setSettings((prev) => ({
                        ...prev,
                        physicalSize: Math.max(1, Number(e.target.value)),
                      }))
                    }
                  ...
                  <span className="text-[#aeb5bf] font-mono text-xs">
                    × {settings.physicalSize} {settings.physicalUnit} (1:1 Repeat Tile)
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-3 gap-1.5">
                {[
                  ...
                  >
                    ...
                    <span className="text-[9px] opacity-75">{rep.desc}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="font-mono text-[11px] text-[#77808c] uppercase tracking-wider font-semibold">
                Fabric Bolt & Seam Allowance
              </div>

              <div className="bg-[#17191e] rounded-md p-3 border border-[#252a31] space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <label className="text-[10px] text-[#77808c]">Bolt Roll Width</label>
                ...
                <div className="pt-2 border-t border-[#252a31]">
                  <div className="flex items-center justify-between mb-1">
                    <label className="text-[10px] text-[#77808c]">Seam Cutting Allowance</label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSettings((prev) => ({
                        ...prev,
                        seamAllowance: Number(e.target.value),
                      }))
                    }
                    className="w-full accent-rose-500 cursor-pointer"
                  />
                  <div className="flex items-center justify-between pt-1">
                    <span className="text-[10px] text-[#77808c]">Show Cutting Margin</span>
                    <input
                      type="checkbox"
                ...
                <div className="pt-2 border-t border-[#252a31]">
                  <div className="flex items-center justify-between mb-1">
                    <label className="text-[10px] text-[#77808c]">Print DPI Resolution</label>
            ...
            <div className="space-y-2">
              ...
              <div className="bg-[#17191e] rounded-md p-3 border border-[#252a31] space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-[10px] text-[#77808c]">Transparent Background</label>
                  <input
                    type="checkbox"
                ...
                {!settings.backgroundTransparent && (
                  <div className="pt-2 border-t border-[#252a31] flex items-center justify-between">
                    <span className="text-[10px] text-[#77808c]">Fabric Base Tone</span>
                    <div className="flex items-center gap-2">
                      <input
                        type="color"

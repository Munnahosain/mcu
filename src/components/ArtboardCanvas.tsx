...
export const ArtboardCanvas: React.FC<ArtboardCanvasProps> = ({
  ...
  const handleElementPointerDown = (
    ...
    instanceOffset: { dx: number; dy: number }
  ) => {
    e.stopPropagation();
  ...
  // Physical units conversion for rulers
  const physicalPerPixel = settings.physicalSize / S;
  ...
  return (
    <div
      ...
      className="flex-1 h-full relative overflow-hidden bg-stone-950 select-none cursor-default"
      onWheel={handleWheel}
                    ...
                    {instances.map((inst, idx) => {
                      ...
                      return (
                        <g
                          ...
                          onPointerDown={(e) =>
                            handleElementPointerDown(e, el, { dx: inst.dx, dy: inst.dy })
                          }
                        >
